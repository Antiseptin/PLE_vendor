...
LOCAL_SRC_FILES_64 := proprietary/vendor/lib64/libaudiopolicymanager.so
LOCAL_SRC_FILES_32 := proprietary/vendor/lib/libaudiopolicymanager.so
LOCAL_MULTILIB := both
...
LOCAL_MODULE_OWNER := nokia
LOCAL_SRC_FILES_64 := proprietary/lib64/libcryptfs_hw.so
LOCAL_MULTILIB := both
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
